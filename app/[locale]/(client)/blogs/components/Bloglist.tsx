  ...
  return (
    <>    
            {Blog.data.map((item, index) => (
              ...
              >
                <Image className="object-cover h-64 w-96" src={item.attributes.thumb.data.attributes.url} height={550} width={400} alt=""/>
                {/* <img height={350} width={200} src={item.attributes.thumb.data.attributes.url} /> */}
                <p
