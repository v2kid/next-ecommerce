...
export default function ProductDetail({params}){
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/3 w-full object-cover object-center rounded-lg border border-gray-200" src={data.image[0]} />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">  {t('brand',{count :2})}</h2>
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">{t('cart',{count : 2})}</button>
