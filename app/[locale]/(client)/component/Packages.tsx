    ...
    return (
        ...
        className="py-[60px] relative z-10" id="packages">
            <div className="max-w-[800px] mx-auto pt-[60px] pb-[30px]">
                <motion.h1 variants={buttonVariant(0.6)} className="text-center py-4 text-[#40E0D0] text-2xl sm:text-4xl font-bold mb-4 overflow-hidden">What We Do</motion.h1>
            </div>   
        ...
        <motion.div  variants={buttonVariant(1)} className="flex flex-wrap flex-row -mx-4 text-center">
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                <div className="py-8 px-12 mb-12 bg-gray-50 bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">SEO Services</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >
                <div className="py-8 px-12 mb-12 bg-gray-50  bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">Social Content</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" >
                <div className="py-8 px-12 mb-12 bg-gray-50 bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">Creative ads</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" >
                <div className="py-8 px-12 mb-12 bg-gray-50 bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">Brand Identity</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >
                <div className="py-8 px-12 mb-12 bg-gray-50 bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">Budget &amp; Marketing</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
            <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                <div className="py-8 px-12 mb-12 bg-gray-50 bg-opacity-0 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 className="text-lg leading-normal mb-2 font-semibold text-slate-300">Optimize conversions</h3>
                    <p className="text-gray-300">This is a wider card with supporting text below as a natural content.</p>
                </div>
            </div>
        </motion.div>
