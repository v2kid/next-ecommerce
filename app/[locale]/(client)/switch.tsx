...
export function Switch() {
  ...
  return (
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
    	...
    	{/* <button onChange={() => changeLocale('en')} classNameName="p-2 flex flex-row items-center border border-gray-300 text-sm font-medium text-gray-700  "
                    >
                         <span classNameName="ml-1"> <img src="https://img.icons8.com/?size=512&id=7PhX5XSLeDb9&format=png" classNameName="w-5 h-5" /></span>
                    </button>
